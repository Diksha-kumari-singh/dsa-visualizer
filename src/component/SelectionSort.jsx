...
import Nav from "./Nav";
import SelectionSortAnimations from "../algorithm/selection";
...
export default function SelectionSort() {
  ...
  return;
    ...
    if (step.type === "compare") {
      ...
      setStatus(
        `Comparing index ${step.indices[0]} and ${step.indices[1]}`
      );
    }
      ...
      <div className="ml-64 w-full p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">
            Watch how the minimum element is selected and placed correctly
          </p>
        </div>
  ...
  <button
    ...
    className={`px-4 py-2 rounded-lg ${
      tab === "code" ? "bg-blue-500" : "bg-gray-700"
    }`}
  >
    Code
  </button>
  ...
  <button
    ...
    className={`px-4 py-2 rounded-lg ${
      tab === "complexity" ? "bg-green-500" : "bg-gray-700"
    }`}
  >
    Complexity
  </button>
  ...
  <button
    ...
    className={`px-4 py-2 rounded-lg ${
      tab === "legend" ? "bg-purple-500" : "bg-gray-700"
    }`}
  >
    Legend
  </button>
...
{`for (let i = 0; i < n; i++) {
  ...
  {tab === "complexity" && (
    <div className="text-lg space-y-2">
      <p>⏱ Time Complexity: <span className="text-green-400">O(n²)</span></p>
      <p>💾 Space Complexity: <span className="text-green-400">O(1)</span></p>
    </div>
  )}
